...
original_link_metrics = {
    ...
    ('I-UPF', 'PSA-UPF'):    {'latency': 2,  'distance': 11, 'load': 0, 'capacity': 20},
    ('I-UPF', 'I-UPF2'):      {'latency': 8,  'distance': 12, 'load': 0, 'capacity': 20},
    ('I-UPF2', 'PSA-UPF2'):   {'latency': 4,  'distance': 9,  'load': 0, 'capacity': 20},
...
# Liste des chemins
paths = {
    "path1": [('gNB1', 'I-UPF'), ('I-UPF', 'PSA-UPF')],
    "path2": [('gNB1', 'I-UPF'), ('I-UPF', 'I-UPF2'), ('I-UPF2', 'PSA-UPF2')],
}
